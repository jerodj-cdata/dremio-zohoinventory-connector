...
@SourceType(value = "ZohoInventoryARP", label = "ZohoInventory",uiConfig = "zohoinventory-layout.json")
public class ZohoInventoryConf extends AbstractArpConf<ZohoInventoryConf> {
  private static final String ARP_FILENAME = "arp/implementation/zohoinventory-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zohoinventory.ZohoInventoryDriver";
